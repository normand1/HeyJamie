...
async function main() {
  ...
  const child = spawn("npx", ["tauri", "dev", "--config", tauriConfig], {
    ...
    env: {
      ...
      VITE_HEYJAMIE_LLM_MODEL: process.env.HEYJAMIE_LLM_MODEL || "google/gemini-2.5-flash",
      HEYJAMIE_LLM_MODEL: process.env.HEYJAMIE_LLM_MODEL || "google/gemini-2.5-flash",
