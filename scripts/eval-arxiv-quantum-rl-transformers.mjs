...
/**
 * End-to-end integration test for the arXiv Quantum RL Transformers scenario.
 *
 * Launches the Tauri app with the arxiv-quantum-rl-transformers mock transcript,
 * waits for the run-complete event in the integration test log, kills the app,
 * and evaluates the log against expectations.
 *
 * Usage:
 *   node scripts/eval-arxiv-quantum-rl-transformers.mjs [--output <report.json>] [--timeout <ms>]
 *
 * Environment:
...
const TRANSCRIPT_ID = "arxiv-quantum-rl-transformers";
const VITE_PORT = 1433;
