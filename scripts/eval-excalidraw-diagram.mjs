...
/**
 * End-to-end integration test for the Excalidraw diagram creation feature.
 *
 * Launches the Tauri app with the excalidraw-diagram mock transcript,
 * waits for the run-complete event in the integration test log, kills the app,
 * and evaluates the log against expectations.
 *
 * Usage:
 *   node scripts/eval-excalidraw-diagram.mjs [--output <report.json>] [--timeout <ms>]
 *
 * Environment:
...
const TRANSCRIPT_ID = "excalidraw-diagram";
const VITE_PORT = 1435;
