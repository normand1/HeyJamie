...
/**
 * End-to-end integration test for the arXiv HTML-over-PDF preference.
 *
 * Launches the Tauri app with the arxiv-html-preference mock transcript,
 * waits for the run-complete event in the integration test log, kills the app,
 * and evaluates the log against expectations.
 *
 * Usage:
 *   node scripts/eval-arxiv-html-preference.mjs [--output <report.json>] [--timeout <ms>]
 *
 * Environment:
...
const TRANSCRIPT_ID = "arxiv-html-preference";
const VITE_PORT = 1434;
